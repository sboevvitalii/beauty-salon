...
export default function MakeupVariants() {
  return (
    <section id="makeup-types" className="py-16 bg-bg-section">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-primary mb-4">Виды макияжа</h2>
          <p className="text-lg text-text-main max-w-2xl mx-auto">
            Подберем идеальный образ под ваш тип внешности и событие
          </p>
        </div>
