...
export default function OurMasters() {
  return (
    <section id="masters" className="py-16">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-primary mb-4">
            Наши спа-специалисты
          </h2>
          <p className="text-lg text-text-main max-w-2xl mx-auto">
            Профессионалы с медицинским образованием и опытом работы
          </p>
        </div>
            ...
            .map((master, index) => (
              ...
              >
                ...
                <div className="flex justify-center items-center gap-4 mb-4 text-sm text-text-main">
                  <span>Опыт {master.exp}</span>
                  <span>•</span>
                  <span>{master.works} процедур</span>
                </div>
